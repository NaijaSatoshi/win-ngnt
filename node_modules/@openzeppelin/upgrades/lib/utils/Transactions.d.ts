...
declare const _default: {
     ...
     */
    sendDataTransaction(contract: Contract, txParams: TxParams, retries?: number): Promise<any>;
    ...
    _sendContractDataTransaction(contract: Contract, txParams: TxParams): Promise<any>;
