...
exports.default = {
    ...
    sendDataTransaction(contract, txParams, retries = RETRY_COUNT) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return this._sendContractDataTransaction(contract, Object.assign(Object.assign({}, txParams), { gas }));
            }
            catch (error) {
    ...
    _sendContractDataTransaction(contract, txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tx = Object.assign(Object.assign({ to: contract.address }, defaults), txParams);
